! function(n) {
    ...
    e.prototype.init = function() {
        ...
        n("#summernote-basic-description").summernote({
            placeholder: "Write something...",
            height: 230,
            callbacks: {
                onInit: function(e) {
        ...
        n("#summernote-basic-feature").summernote({
            placeholder: "Write something...",
            height: 230,
            callbacks: {
                onInit: function(e) {
        ...
        n("#summernote-basic1").summernote({
            placeholder: "Write something...",
            height: 630,
            toolbar: [
                ['style', ['bold', 'italic', 'underline', 'clear']],
        ...
        n("#summernote-basic4").summernote({
            placeholder: "Write something...",
            height: 630,
            toolbar: [
                ['style', ['bold', 'italic', 'underline', 'clear']],
        ...
        n("#summernote-basic5").summernote({
            placeholder: "Write something...",
            height: 630,
            toolbar: [
                ['style', ['bold', 'italic', 'underline', 'clear']],
        ...
        n("#summernote-basic6").summernote({
            placeholder: "Write something...",
            height: 630,
            toolbar: [
                ['style', ['bold', 'italic', 'underline', 'clear']],
        ...
        n("#summernote-basic7").summernote({
            placeholder: "Write something...",
            height: 630,
            toolbar: [
                ['style', ['bold', 'italic', 'underline', 'clear']],
        ...
        n("#summernote-basic8").summernote({
            placeholder: "Write something...",
            height: 630,
            toolbar: [
                ['style', ['bold', 'italic', 'underline', 'clear']],
