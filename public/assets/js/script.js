...
/*------------------------------------------
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2023/09/08', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div><div class="time">%D</div> <span><small>Days</small></span> </div></div>'
            + '<div class="box"><div><div class="time">%H</div> <span><small>Hours</small></span> </div></div>'
            + '<div class="box"><div><div class="time">%M</div> <span><small>Mins</small></span> </div></div>'));
        });
    }
    ...
    if ($("#contact-form-main").length) {
        $("#contact-form-main").validate({
            ...
            messages: {
                ...
                arrival: "Please select your arrival confirmation"
            },
